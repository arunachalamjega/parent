...
public class FiltroAutenticacion implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        String res =((HttpServletRequest) servletRequest).getRequestURI();
        Logger.getLogger(this.getClass().getName()).log(Level.INFO, "requri:"+res);
        ...
        if (urlSolicitada.endsWith("/index.jsp"))
            urlSolicitada = "/";
        ...
        Logger.getLogger(this.getClass().getName()).log(Level.INFO, "info5" + urlSolicitada);
        ...
        if(ctrlServicio.usuarioPuedeAcceder(usuarioSesion, servicioSolicitado)) {
            ...
            Logger.getLogger(this.getClass().getName()).log(Level.INFO,"Deep0 :->"+ctrlServicio.obtenerServicioPorUrl(urlSolicitada));
            sesion.setAttribute(ISesion.SERVICIO, ctrlServicio.obtenerServicioPorUrl(urlSolicitada));
            Logger.getLogger(this.getClass().getName()).log(Level.INFO,"Deep1 :->"+((HttpServletRequest) servletRequest).getRequestURL().toString());
            filterChain.doFilter(servletRequest, servletResponse);
            return;
        }
